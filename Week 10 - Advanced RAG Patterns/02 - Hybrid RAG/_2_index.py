# What this file does: reads the product-guide PDFs, chunks them, embeds them, and saves them in Chroma.
...
from _1_stores import COLLECTION_NAME, DATABASE_DIRECTORY, DOCS_DIRECTORY, get_embedder
...
def main() -> None:
    ...
    # More overlap than the fables, so an error code and its fix stay in one chunk.
